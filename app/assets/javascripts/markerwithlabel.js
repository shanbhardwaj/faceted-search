 ...
 * @private
 */
function MarkerLabel_(marker,text, crossURL, handCursorURL) {
  this.marker_ = marker;
  this.handCursorURL_ = marker.handCursorURL;

  this.labelDiv_ = document.createElement("div");
  this.labelDiv_.setAttribute('id', "marker_"+text);
...
opt = opt_options;
  opt_options.id = opt_options.id;
  opt_options.labelContent = opt_options.labelContent || "";
  opt_options.labelAnchor = opt_options.labelAnchor || new google.maps.Point(0, 0);
  opt_options.labelClass = opt_options.labelClass || "markerLabels";
  opt_options.labelStyle = opt_options.labelStyle || {};
  opt_options.labelInBackground = opt_options.labelInBackground || true;
  ...
  this.label = new MarkerLabel_(this, opt_options.labelContent,opt_options.crossImage, opt_options.handCursor); // Bind the label to the marker
...
MarkerWithLabel.prototype = new google.maps.Marker({icon:"/assets/red-dot.png"});
